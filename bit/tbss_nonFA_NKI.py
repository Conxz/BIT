...
sessdir = '/nfs/p1/public_dataset/datasets/NKI_Sample/preproc/dtifit/DTIFit/'
sessid = '/nfs/p1/public_dataset/datasets/NKI_Sample/docs/sessid_mri_dti_rest.txt'
fsessid = open(sessid)
subject_list = [line.strip() for line in fsessid]

sinkdir = '/nfs/p1/public_dataset/datasets/NKI_Sample/preproc/TBSS'
tbssDir = '/nfs/p1/public_dataset/datasets/NKI_Sample/workingdir/'
skeleton_thr = 0.2
nonFA = 'MO'#'AD'/'RD'/'MD'/'MO'

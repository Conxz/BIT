...
srcdir = '/nfs/p1/public_dataset/datasets/Conxz/NP160211/raw/'
#subdirs = ['Ctrls', 'Exps']
subdirs = ['Ctrls_new']

tgtdir = '/nfs/p1/public_dataset/datasets/Conxz/NP160211/data/'

subjfile = '/nfs/p1/public_dataset/datasets/Conxz/NP160211/subj/sesslist_new'
sesslist = []
